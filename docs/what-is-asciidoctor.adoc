...
Asciidoctor is published as a RubyGem and currently works with Ruby 1.8.7, Ruby 1.9.3, Ruby 2.0.0, Ruby 2.1.2, JRuby 1.7.2 and Rubinius 1.2.4 on Linux, Mac and Windows. 
